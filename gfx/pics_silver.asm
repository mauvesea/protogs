...
SECTION "Pics New Mon", ROMX

Piloswine2Frontpic:  INCBIN "gfx/pokemon/piloswine2/front_gold.2bpp.lz"
Piloswine2Backpic:   INCBIN "gfx/pokemon/piloswine2/back.2bpp.lz"
