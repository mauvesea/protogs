...
FalknerGroup:
	...
	db 10, PIDGEY,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db 10, PIDGEOTTO,  TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db 10, PIDGEOT,    TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
JasmineGroup:
	...
	db 29, MAGNEMITE,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 29, MAGNEMITE,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 33, STEELIX,    SCREECH, SUNNY_DAY, ROCK_THROW, IRON_TAIL
	db -1 ; end
...
Rival1Group:
	...
	db 20, GASTLY,    LICK, SPITE, MEAN_LOOK, CURSE
	db 18, RHYHORN,   HORN_ATTACK, TAIL_WHIP, STOMP, FURY_ATTACK
	db 20, GOLBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
	...
	db 28, RHYHORN,    HORN_ATTACK, TAIL_WHIP, STOMP, FURY_ATTACK
	...
	db 35, RHYHORN,    HORN_ATTACK, HORN_DRILL, STOMP, FURY_ATTACK
...
BrunoGroup:
	...
	db 44, POLIWRATH,  SUBMISSION, ICE_PUNCH, DOUBLE_TEAM, EARTHQUAKE
...
KarenGroup:
	...
	db 42, ARBOK,      BITE, GLARE, ATTRACT, TOXIC
...
KogaGroup:
	...
	db 43, WEEZING,    PROTECT, SMOKESCREEN, EXPLOSION, SLUDGE
...
CooltrainerMGroup:
	...
	db 27, CHARIZARD, FLAMETHROWER, SMOKESCREEN, RAGE, SCARY_FACE
	db -1 ; end
...
Rival2Group:
	...
	db 42, RHYDON,     HORN_ATTACK, HORN_DRILL, STOMP, EARTHQUAKE
	db 45, GENGAR,     MEAN_LOOK, CURSE, SHADOW_BALL, CONFUSE_RAY
	db 45, ALAKAZAM,   DISABLE, RECOVER, FUTURE_SIGHT, PSYCHIC_M
	...
	db 51, RHYDON,     HORN_ATTACK, HORN_DRILL, STOMP, EARTHQUAKE
...
PicnickerGroup:
	...
	db 11, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db 12, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db 13, PIKACHU,    THUNDERSHOCK, GROWL, QUICK_ATTACK, DOUBLE_TEAM
	db -1 ; end
...
ExecutiveFGroup:
	; EXECUTIVEF (1)
	db "EXECUTIVE@", TRAINERTYPE_MOVES
	db 32, TANGELA,    MEGA_DRAIN, STUN_SPORE, POISONPOWDER, SLEEP_POWDER
	db 32, TANGELA,    MEGA_DRAIN, STUN_SPORE, POISONPOWDER, SLEEP_POWDER
...
RedGroup:
	...
	db 70, PIKACHU,    CHARM, QUICK_ATTACK, THUNDERBOLT, THUNDER
	db 65, VENUSAUR,   SUNNY_DAY, GIGA_DRAIN, SYNTHESIS, SOLARBEAM
	db 65, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, FIRE_SPIN
	db 65, BLASTOISE,  RAIN_DANCE, SURF, BLIZZARD, WHIRLPOOL
	db 63, ESPEON,     MUD_SLAP, REFLECT, SWIFT, PSYCHIC_M
	db 63, SNORLAX,    AMNESIA, SNORE, REST, BODY_SLAM
	db -1 ; end

BlueGroup:
	; BLUE (1)
	db "BLUE@", TRAINERTYPE_MOVES
	db 48, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 46, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 48, RHYDON,     FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 53, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 53, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	db 53, ARCANINE,   ROAR, SWIFT, FLAMETHROWER, EXTREMESPEED
	db -1 ; end
