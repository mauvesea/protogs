...
WhitneyGroup:
	...
	db 14, CLEFAIRY,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
	db 14, AIPOM,      SCRATCH, DOUBLESLAP, PURSUIT, NO_MOVE
	db 16, MILTANK,    ROLLOUT, ATTRACT, STOMP, MILK_DRINK
	db -1 ; end

BugsyGroup:
	; BUGSY (1)
	db "BUGSY@", TRAINERTYPE_MOVES
	db 18, LEDIAN,     TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 18, ARIADOS,    POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 20, HERACROSS,  QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end
...
PryceGroup:
	...
	db 30, SNEASEL,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
	db 30, DEWGONG,    HEADBUTT, ICY_WIND, AURORA_BEAM, REST
...
JasmineGroup:
	...
	db 30, SKARMORY,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
...
ChuckGroup:
	...
	db 35, HITMONLEE, TACKLE, NO_MOVE, NO_MOVE, NO_MOVE
	db 35, HITMONCHAN, TACKLE, NO_MOVE, NO_MOVE, NO_MOVE
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, FLAMETHROWER, SLAM, DRAGONBREATH
