...
MapGroup_Violet:
	...
	map VioletBillsHouse, TILESET_RADIO_TOWER, INDOOR, LANDMARK_VIOLET_CITY, MUSIC_VIOLET_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_NewBark:
	...
	map SilentHill, TILESET_CAVE, CAVE, LANDMARK_ROUTE_29, MUSIC_UNION_CAVE, TRUE, PALETTE_NITE, FISHGROUP_LAKE
	map NewBarkPokecenter1F, TILESET_POKECENTER, INDOOR, LANDMARK_NEW_BARK_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE	
...
MapGroup_Cherrygrove:
	...
	map MrPokemonsHouse, TILESET_FACILITY, INDOOR, LANDMARK_CHERRYGROVE_CITY, MUSIC_CHERRYGROVE_CITY, FALSE, PALETTE_DAY, FISHGROUP_SHORE
