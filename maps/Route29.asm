...
Route29_MapEvents:
	...
	warp_event 46,  9, SILENT_HILL, 1
	warp_event 20,  9, SILENT_HILL, 2
	warp_event 34, 11, SILENT_HILL, 3
	warp_event 44,  7, SILENT_HILL, 4
	...
	def_bg_events
	bg_event 54,  7, BGEVENT_READ, Route29Sign1
	bg_event  2,  6, BGEVENT_READ, Route29Sign2
	...
	object_event 43,  5, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route29FruitTree, -1
	...
	object_event 48,  5, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route29Potion, EVENT_ROUTE_29_POTION
