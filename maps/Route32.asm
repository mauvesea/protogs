...
Route32_MapEvents:
	...
	bg_event  8, 76, BGEVENT_READ, Route32UnionCaveSign
	...
	object_event 13, 77, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_TRAINER, 3, TrainerBirdKeeperPeter, -1
