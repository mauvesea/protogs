...
PlayersHouse2FTrGearScript:
	opentext
	writetext PlayersHouseTrainerGearText1
	promptbutton
	disappear PLAYERSHOUSE2F_POKE_BALL
	waitsfx
	writetext PlayersHouseTrainerGearText2
	playsound SFX_ITEM
	waitsfx
	closetext
...
PlayersHouseTrainerGearText1:
	text "It's my TRAINER"
	line "GEAR! It's been"
	cont "repaired."
	done

PlayersHouseTrainerGearText2:	
	text "<PLAYER> got"
	line "TRAINER GEAR!"
	done
...
PlayersHouse2F_MapEvents:
	...
	object_event  2,  1, SPRITE_DOLL_1, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PlayersHouseDoll1Script, EVENT_PLAYERS_HOUSE_2F_DOLL_1
	object_event  6,  4, SPRITE_BIG_DOLL, SPRITEMOVEDATA_BIGDOLL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PlayersHouseBigDollScript, EVENT_PLAYERS_HOUSE_2F_BIG_DOLL
	object_event  2,  1, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, PlayersHouse2FTrGearScript, EVENT_PLAYERS_HOUSE_2F_TR_GEAR
