...
AzaleaTown_MapEvents:
	...
	def_warp_events
	warp_event 15,  5, AZALEA_POKECENTER_1F, 1
	warp_event  5,  9, CHARCOAL_KILN, 1
	warp_event  5,  5, AZALEA_MART, 2
	warp_event 13, 11, KURTS_HOUSE, 1
	warp_event  0,  0, AZALEA_GYM, 1
	warp_event 31,  7, SLOWPOKE_WELL_B1F, 1
	warp_event  0,  0, ILEX_FOREST_AZALEA_GATE, 3
	warp_event  0,  0, ILEX_FOREST_AZALEA_GATE, 4

	def_coord_events
	coord_event  0,  0, SCENE_AZALEATOWN_RIVAL_BATTLE, AzaleaTownRivalBattleScene1
	coord_event  0,  0, SCENE_AZALEATOWN_RIVAL_BATTLE, AzaleaTownRivalBattleScene2

	def_bg_events
	bg_event 10,  6, BGEVENT_READ, AzaleaTownSign
	bg_event 11, 11, BGEVENT_READ, KurtsHouseSign
	bg_event  0,  0, BGEVENT_READ, AzaleaGymSign
	bg_event 29,  7, BGEVENT_READ, SlowpokeWellSign
	bg_event  0,  0, BGEVENT_READ, CharcoalKilnSign
	bg_event 16,  5, BGEVENT_READ, AzaleaTownPokecenterSign
	bg_event  6,  5, BGEVENT_READ, AzaleaTownMartSign
	bg_event  0,  0, BGEVENT_READ, AzaleaTownIlextForestSign
	...
	object_event  0,  0, SPRITE_GRAMPS, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownGrampsScript, -1
	object_event  0,  0, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_UP_DOWN, 0, 2, -1, -1, PAL_NPC_BLUE, OBJECTTYPE_SCRIPT, 0, AzaleaTownTeacherScript, -1
	object_event  0,  0, SPRITE_YOUNGSTER, SPRITEMOVEDATA_WALK_LEFT_RIGHT, 1, 0, -1, -1, PAL_NPC_GREEN, OBJECTTYPE_SCRIPT, 0, AzaleaTownYoungsterScript, -1
	object_event  0,  0, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	object_event  0,  0, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	...
	object_event  0,  0, SPRITE_SLOWPOKE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownSlowpokeScript, EVENT_AZALEA_TOWN_SLOWPOKES
	object_event  0,  0, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WhiteApricornTree, -1
	object_event  0,  0, SPRITE_AZALEA_ROCKET, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_RIVAL_AZALEA_TOWN
	object_event  0,  0, SPRITE_AZALEA_ROCKET, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, AzaleaTownRocket2Script, EVENT_SLOWPOKE_WELL_ROCKETS
